        ...
        for row in period_summary:
            ...
            summary_rows.append(
                (
                    ...
                    row.get("spill_years_count"),
                    row.get("spill_frequency_pct"),
                    row.get("spill_mean_cfs"),
                    row.get("spill_peak_cfs"),
                    row.get("annual_spill_avg_taf"),
                    row.get("annual_spill_cv"),
                    row.get("annual_spill_max_taf"),
                    row.get("annual_max_spill_q50"),
                    row.get("annual_max_spill_q90"),
                    row.get("annual_max_spill_q100"),
                    # Probability metrics
