...
CREATE TABLE reservoir_period_summary (
    ...
    reservoir_entity_id INTEGER NOT NULL,
    ...
    -- ============================================================
    storage_exc_p5 NUMERIC(6,2),
    storage_exc_p10 NUMERIC(6,2),
    storage_exc_p25 NUMERIC(6,2),
    storage_exc_p50 NUMERIC(6,2),
    storage_exc_p75 NUMERIC(6,2),
    storage_exc_p90 NUMERIC(6,2),
    storage_exc_p95 NUMERIC(6,2),

    -- ============================================================
    -- THRESHOLD MARKERS (for horizontal lines on charts)
    -- ============================================================
    dead_pool_taf NUMERIC(10,2),
    dead_pool_pct NUMERIC(6,2),
    spill_threshold_pct NUMERIC(6,2),
    ...
    spill_frequency_pct NUMERIC(5,2),

    spill_mean_cfs NUMERIC(10,2),
    spill_peak_cfs NUMERIC(10,2),

    annual_spill_avg_taf NUMERIC(10,2),
    annual_spill_cv NUMERIC(6,4),
    annual_spill_max_taf NUMERIC(10,2),

    annual_max_spill_q50 NUMERIC(10,2),
    annual_max_spill_q90 NUMERIC(10,2),
    annual_max_spill_q100 NUMERIC(10,2),
