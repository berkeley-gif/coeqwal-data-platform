...
CREATE TABLE reservoir_spill_monthly (
    ...
    spill_avg_cfs NUMERIC(10,2),
    spill_max_cfs NUMERIC(10,2),

    spill_q50 NUMERIC(10,2),
    spill_q90 NUMERIC(10,2),
    spill_q100 NUMERIC(10,2),

    storage_at_spill_avg_pct NUMERIC(6,2),
