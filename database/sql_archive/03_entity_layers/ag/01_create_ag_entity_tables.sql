...
CREATE TABLE du_agriculture_entity (
    ...
    agency VARCHAR(200),
    provider VARCHAR(50),
    gw BOOLEAN DEFAULT TRUE,
    sw BOOLEAN DEFAULT TRUE,
    point_of_diversion TEXT,
    diversion_arc VARCHAR(50),
    river_reach VARCHAR(200),
    river_mile_start NUMERIC(10,2),
    river_mile_end NUMERIC(10,2),
    bank VARCHAR(20),
    area_acres NUMERIC(12,2),
    annual_diversion_taf NUMERIC(10,2),
...
CREATE TABLE ag_aggregate_entity (
    ...
    project VARCHAR(10),
    region VARCHAR(10),
    delivery_variable VARCHAR(100) NOT NULL,
    description TEXT,
