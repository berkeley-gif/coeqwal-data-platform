...
-- s0065: self-referencing DCP root
...
-- All inserted with NULL baseline first, then baselines set in STEP 5b.
...
-- STEP 5b: Set CC50 baseline_scenario_id values (within-hydroclimate)
-- s0048 (root): stays NULL
-- s0051 (USBR root, no cc50 of s0022): stays NULL
-- s0078-s0081 (Alt3, no cc50 of s0038): stay NULL
...
-- STEP 6b: Set CC95 baseline_scenario_id values (within-hydroclimate)
-- s0057 (root): stays NULL
-- s0060 (USBR root, no cc95 of s0022): stays NULL
-- s0098-s0101 (Alt3, no cc95 of s0038): stay NULL
