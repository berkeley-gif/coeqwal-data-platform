...
--        refuge_du_delivery_monthly  → statistics family
--        refuge_du_shortage_monthly  → statistics family
--        refuge_du_period_summary    → statistics family
--        du_refuge_entity            → entity family  (also done in migration 20,
...
-- Statistics tables → 'statistics' version family
...
-- Entity table → 'entity' version family
-- (also upserted by migration 20; ON CONFLICT makes this idempotent)
INSERT INTO domain_family_map (schema_name, table_name, version_family_id, note, created_by, updated_by)
