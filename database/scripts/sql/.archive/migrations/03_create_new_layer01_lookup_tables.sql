...
-- =============================================================================
-- Run with: psql $SUPERUSER_URL -f database/scripts/sql/migrations/03_create_new_layer01_lookup_tables.sql
-- =============================================================================
--
-- Changes:
--   1. Grant SELECT on variable_type to jfantauzza
--   2. Create watershed               + seed 9 rows
--   3. Create calsim_model_variable_type + seed 8 rows
--   4. Create derived_variable_type   + seed 4 rows
--   5. Grant full access on new tables to jfantauzza
--
-- =============================================================================
...
-- CalSim model variable behavior classification (more granular than
-- calsim_variable_type which covers output/state/decision only).
...
-- Classification for derived/computed variables (not raw CalSim outputs).
