...
-- ── Disable all user triggers on the 38 tables ──────────────────────
...
-- ── Verification 2: All triggers re-enabled ─────────────────────────
-- tgenabled: O = enabled (normal), D = disabled
-- This should return ZERO rows. Any rows = a trigger left disabled.
\echo
