...
-- Corrects provenance on all Layer 01 lookup tables (created_by/updated_by → 2)
-- and registers missing Layer 01 tables in domain_family_map.
-- =============================================================================
-- Run with: psql $SUPERUSER_URL -f database/scripts/sql/migrations/04_layer01_provenance_and_domain_map.sql
-- =============================================================================
--
-- Developer id=1  → system@coeqwal.local  (bootstrap, used by migrations)
-- Developer id=2  → jfantauzza@berkeley.edu (admin, correct owner of lookup data)
--
-- =============================================================================
