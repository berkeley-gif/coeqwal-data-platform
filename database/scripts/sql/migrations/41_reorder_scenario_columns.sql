...
-- ── 2. Drop FKs FROM other tables pointing TO scenario(id) ──────────
...
-- ── 4. Drop indexes (PK and UNIQUE dropped with constraints below) ──
...
-- ── 6. Create new table with desired column order ────────────────────
...
-- ── 15. FKs FROM other tables TO scenario(id) ────────────────────────
...
-- ── 16. Recreate scenario_full view (from migration 36) ──────────────
