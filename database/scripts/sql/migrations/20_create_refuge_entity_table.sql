...
CREATE TABLE du_refuge_entity (
    ...
    -- Water source flags (CalSim 3 Main Report Tables 3-9 and 3-10)
...
-- Path is relative to the directory where psql is invoked (repo root).
-- CSV column order matches du_refuge_entity.csv header exactly.
