...
-- ── 1. Create scenario_tag lookup table ─────────────────────────────
...
-- ── 2. Seed tags from the scenario metadata doc ─────────────────────
...
-- ── 3. Create scenario_tag_link crosswalk table ─────────────────────
...
-- ── 4. Populate scenario_tag_link from the metadata doc ─────────────
-- Tags per scenario based on the "Themes" field in the scenario doc.
...
WHERE (s.short_code, t.short_code) IN (
    ...
    -- s0025: Groundwater
    ('s0025', 'groundwater'),
    -- s0026: Groundwater, Agriculture
    ('s0026', 'groundwater'), ('s0026', 'agriculture'),
    -- s0027: Groundwater
    ('s0027', 'groundwater'),
    -- s0028: Groundwater, Agriculture
    ...
    -- s0033: Flows
    ('s0033', 'flows'),
    -- s0035: Drinking water
    ('s0035', 'drinking_water'),
    -- s0036: Drinking water
    ('s0036', 'drinking_water'),
    -- s0037: Drinking water
    ...
    -- s0044: Reservoir, Salmon, Agriculture
    ('s0044', 'reservoir'), ('s0044', 'salmon'), ('s0044', 'agriculture'),
    -- s0045: Delta, Flows, Environment
    ('s0045', 'delta'), ('s0045', 'flows'), ('s0045', 'environment'),
    -- s0046: Flows
    ('s0046', 'flows'),
    -- s0065: Infrastructure, Delta, Flows
