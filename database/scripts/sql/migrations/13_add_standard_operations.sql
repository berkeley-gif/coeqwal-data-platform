...
-- ─── Insert new operation_definition rows ─────────────────────────────────────
...
VALUES
    ...
    -- biops: modified 2019 (used by Alt3 and s0044/s0045)
    ...
    -- infrastructure: standard / no DCP
    (24, 'infra_standard',
    ...
    -- flow: standard / existing min flows
    (25, 'flow_standard',
    ...
    -- comm_delivery: standard CVP/SWP allocation
    (27, 'alloc_standard',
    ...
    -- comm_delivery: CVP Settlement to 0% (Alt3 scenarios)
...
-- Advance the sequence to max id so future auto-inserts do not conflict
