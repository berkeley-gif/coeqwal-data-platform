...
--
-- DEPRECATED SPIKE (May 2026): added geom columns directly on du_*_entity
-- tables. Project policy is dedicated geometry tables only (see
-- docs/database_geometry_pattern.md). Do not apply on new environments.
-- Planned follow-up: create du_urban / du_agriculture / du_refuge geometry
-- tables and drop these entity columns.
--
