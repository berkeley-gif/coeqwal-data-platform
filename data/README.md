...
Where to find the source data the backend depends on. Most of it lives outside this repo (Google Drive, Google Sheets, a separate GIS repo). The most important reference file is the CalSim manual pdf, which is too large to house outside LFS, but you can download it from DWR at https://water.ca.gov/Library/Modeling-and-Analysis/Central-Valley-models-and-tools/CalSim-3.

## Where to find the data and data lists
...
| CalSim Geopackage | GIS source for nodes, arcs (channels), demand units, water budget areas, and watersheds. | The latest version I'm aware of: https://drive.google.com/file/d/1_1TaClea8peTnPB8CnglajhHDyXEtQi8/view?usp=drive_link |
...
- [`INFRASTRUCTURE.md`](https://github.com/berkeley-gif/coeqwal-private-docs) - S3 bucket, Drive, and Cloud9 details (in the private `coeqwal-private-docs` repository)
